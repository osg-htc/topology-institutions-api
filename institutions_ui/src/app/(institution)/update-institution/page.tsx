...
export default function Page() {
  ...
  const handleFieldChange = (
    ...
    if (field === 'name' && value && errors.name) {
      ...
      field === 'ror_id' &&
      (!value || /^https:\/\/ror\.org\/.+$/.test(value)) &&
      errors.ror_id
    ) {
            ...
            <form onSubmit={handleSave}>
              <Item>
                ...
                <TextField
                  ...
                  helperText={
                    errors.name ||
                    'Should match name from ROR id included below'
                  }
                />
              </Item>
              <Item>
...
const validateForm = (institution: Institution | undefined) => {
  ...
  if (
    ...
    isNaN(parseFloat(institution?.longitude as string))
  ) {
  ...
  if (
    ...
    isNaN(parseFloat(institution?.latitude as string))
  ) {
